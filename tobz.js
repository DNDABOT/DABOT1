...
module.exports = tobz = async (tobz, message) => {
	...
	const sotoy = [
        ...
        const mess = {
            wait: 'Wait a...!',
            magernulissatu: 'Wait a... Silahkan tunggu sebentar!',
            error: {
                St: 'Kirim gambar dengan caption ${prefix}sticker, atau reply gambar yang sudah dikirim!',
                Ti: 'Kirim gambar dengan caption ${prefix}toimg, atau reply gambar yang sudah dikirim!',
	...
	if (isGroupMsg && AntiStickerSpam && !isGroupAdmins && !isAdmin && !isOwner){
        ...
        case prefix+'lovemessage':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}lovemessage <teksnya>, contoh ${prefix}lovemessage Ambrose ganteng`, id)
        ...
        case prefix+'romance':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}romance <teksnya>, contoh ${prefix}romance Ambrose ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'party':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}party <teksnya>, contoh ${prefix}party Ambrose ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'silk':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}silk <teksnya>, contoh ${prefix}silk Ambrose ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'blackpink':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}blackpink <teksnya>, contoh ${prefix}blackpink Ambrose ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'thunder':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}thunder <teksnya>, contoh ${prefix}thunder Ambrose ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'pornhub':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /Ambrose /ganteng`, id)
            ...
            if (argz.length >= 2) {
                ...
                await tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /Ambrose /ganteng`, id)
            }
            break
        case prefix+'glitch':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}glitch /teks1 /teks2, contoh ${prefix}glitch /Ambrose /ganteng`, id)
            argz = body.trim().split('/')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
                ...
                await tobz.reply(from, `Kirim perintah ${prefix}glitch /teks1 /teks2, contoh ${prefix}glitch /Ambrose /ganteng`, id)
            }
            break
        case prefix+'daftar':
                argz = body.trim().split('/')
...
${desc}`)
        ...
        case prefix+'tts':
            ...
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            try {
                if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}tts <kode bahasa> <teksnya>, Contoh ${prefix}tts id Ambrose ganteng\nUntuk melihat kode bahasa ketik .bahasa')
                var dataBhs = args[1]      
        ...
        case prefix+'kapan':
            ...
            if (!when) tobz.reply(from, 'Format salah! ketik ${prefix}kapankah <teksnya>, Contoh ${prefix}kapankah saya nikah?')
        ...
        case prefix+'rate':
            ...
            if (!rating) tobz.reply(from, 'Format salah! ketik ${prefix}nilai <teksnya>, Contoh ${prefix}nilai kegantengan saya')
        ...
        case prefix+'apakah':
            ...
            if (!nanya) tobz.reply(from, 'Format salah! ketik ${prefix}apakah <teksnya>, Contoh ${prefix}apakah saya ganteng?')
         ...
         case prefix+'bisakah':
            ...
            if (!bsk) tobz.reply(from, 'Format salah! ketik ${prefix}bisakah <teksnya>, Contoh ${prefix}bisakah saya menjadi pintar?.')
        ...
        case prefix+'ownerbot':
            ...
            tobz.reply(from, 'Itu nomer owner bot a!', id)
            break
                    ...
                    const cus = text + '@c.us'
                        ...
                        if (found !== false) {
                            ...
                            limitAdd(serial)
                                ...
                                tobz.reply(from, `${monospace(`Di database ngga ada nomer itu a`)}`, id)
                        }
                break
        // ON OFF
        ...
        case prefix+'kusonime':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}kusonime <query>, Contoh : ${prefix}kusonime naruto', id)
        ...
        case prefix+'dewabatch':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}dewabatch <query>, Contoh : ${prefix}dewabatch naruto', id)
        ...
        case prefix+'pinterest':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}pinterest <query>, Contoh : ${prefix}pinterest Dahyun', id)
...
🌐️ *URL*: ${url}`
        ...
        case prefix+'infosurah': // ARUGAZ
            ...
            if (args.length == 1) return tobz.reply(from, `Kirim perintah ${prefix}infosurah <nama surah>\nContoh : ${prefix}infosurah al-fatihah\nUntuk nama surah cek di ${prefix}listsurah`, message.id)
                ...
                try {
                    ...
                    tobz.reply(from, 'Nama surah tidak ditemukan, ketik ${prefix}listsurah untuk melihat daftar surah. Penulisan koma, titik harus benar!', id)
                }
            break
	...
	case prefix+'bitly':
        ...
        case prefix+'play':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (!isAdmin) return tobz.reply(from, `Perintah ini hanya bisa di gunakan oleh Admin Ambrose!`, id)
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}ceklimit Untuk Mengecek Kuota Limit Kamu`, id)
	...
	case prefix+'moddroid':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}moddroid [query]*\nContoh : *${prefix}moddroid darling pubg*', id)
            try {
        ...
        case prefix+'happymod':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}happymod [query]*\nContoh : *${prefix}happymod darling pubg*', id)
            try {
        ...
        case prefix+'nhentai': // SEARCH NHENTAI
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            tobz.reply(from, 'PREMIUM COMMAND, HUBUNGI : wa.me/6285747852482', id)
          break
        ...
        case prefix+'xnxx':
            ...
            if (!isNsfw) return tobz.reply(from, 'Perintah belum dapat digunakan, karena fitur belum diaktifkan oleh admin!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}xnxx [linkXnxx]*, untuk contoh silahkan kirim perintah *${prefix}readme*')
        ...
        case prefix+'ramalpasangan':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'kirim perintah ${prefix}ramalpasangan Ambrose & Dahyun', id)
            argz = body.trim().split('&')
            if (argz.length >= 2) {
            tobz.reply(from, mess.wait, id)
            const kamu = argz[0]
        ...
        case prefix+'zodiak':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}zodiaka <zodiak>, Contoh : ${prefix}zodiak Scorpio', id)
            try {
        ...
        case prefix+'artimimpi':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah ${prefix}artimimpi <mimpi apa>\nContoh : ${prefix}artimimpi ular', id)
            try {
        ...
        case prefix+'wiki':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}wiki <query>, Contoh : ${prefix}wiki reinkarnasi`, id)
        ...
        case prefix+'googleimage':
            ...
            const qwery = argz[1]
            const jum = argz[2]
            if(!qwery) return await tobz.reply(from, `Kirim perintah *${prefix}googleimage [ |Query|Jumlah ]*, contoh = ${prefix}googleimage |Dahyun|3`, id)
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'quotemaker':
            ...
            if (argz.length >= 4) {
                ...
                tobz.reply(from, 'Kirim perintah ${prefix}quotemaker /nama/teksnya/temanya\nContoh ; !quotemaker /Ambrose/Dek posting cringe/Laut', id)
            }
            break
        ...
        case prefix+'nulis':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}nulis [teks]*, contoh *${prefix}nulis aku bukan boneka*', id)
        ...
        case prefix+'lirik':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length == 1) return tobz.reply(from, 'Kirim perintah *${prefix}lirik [optional]*, contoh *${prefix}lirik Sugeng dalu*', id)
        ...
        case prefix+'chord':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}chord [query]*, contoh *${prefix}chord sugeng dalu*', id)
        ...
        case prefix+'tampar':
            ...
            tobz.sendTextWithMentions(from, '@' + person + ' Menampol dengan keras si ' + slap)
            limitAdd(serial)
            break
        ...
        case prefix+'gantiprefix':
            if(!isOwner) return tobz.reply(from, `Perintah hanya dapat digunakan oleh *DABOTBOT*!`, id)
        ...
        case prefix+'kasihlimit': // Hanya Admin & Owner Elaina yang bisa gift Limit
            if (!isAdmin, !isOwner) return tobz.reply(from, `Perintah hanya dapat digunakan oleh *Member premium*!`, id)
                    ...
                    if(jmla > 999) return await tobz.reply(from, `Melebihi batas maksimal!`, id)
                        var found = false
                        Object.keys(limit).forEach((i) => {
                            if(limit[i].id == cusz){
                                found = i
                        ...
                        if (found !== false) {
                            ...
                            if(limit[found].limit <= 999) return tobz.reply(from, `Kuota Limit pada nomor tersebut masih penuh\nUntuk gift pastikan kuota limit target sudah habis`, id)
...
• Limit: ${limitCount-updated.limit}`
	...
	//list menu
        ...
        case prefix+'premiummenu':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin DABOT', id)
...
//BY SYAHRUL SARIZ
        ...
        case prefix+'nulis1':
            ...
            if (!isAdmin) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh member *premium*!\nKetik ${prefix}daftarpremium untuk menjadi member premium!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}nulis1 /nama/kelas/teksnya, contoh ${prefix}nulis1 /Ambrose/12TKR2/Ujian tengah semester`, id)
            argz = body.trim().split('/')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
        ...
        default:
            ...
            if (command.startsWith('.')) {
                tobz.reply(from, `Maaf ${pushname}, Perintah *${args[0]}* tidak terdaftar didalam ${prefix}menu`, id)
            }
            await tobz.sendSeen(from) 
            }
        }
